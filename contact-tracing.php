...
<body>
    ...
    <!--Carousel Banner-->
        <div class="container" style="margin-top:90px; width:100%;">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-12" style="border: 1px solid #FF4600;border-radius:10px 10px 10px 10px;margin-bottom: 20px; padding:10px;">
    ...
    <script>
        ...
        function scancodeinput(){
            ...
            if($('#qr-code-output').val() == ''){
                ...
                $.ajax({
                method: "POST",
                url: "contact-tracing-function.php",
        ...
        function inserttracing(){
            var getinsert = $('#qr-code-output').val();
            $.ajax({
                method:"POST",
                url: "contact-tracing-insert.php",
                data: {getinsert:getinsert},
                success: function (data) {
                    $('#tracing-message').html(`
                    <div class="alert alert-success" role="alert">
                        <strong>Insert Tracing data successfully</strong>
                    </div>
                    `);
                    //console.log(data);
                }
