...
<!-- UNIVERSAL MODAL -->
    <div class="modal" id="print-modal" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="print-modal-title">
                        Print Report
                        <!-- Modal title -->
                    </h5>
...
<script>
    ...
    function tablefetch(){
        ...
        function userroleselection(){
            $.ajax({
                type: "POST",
                url: "user-account-role-selection.php",
                success: function (data) {
                    $('#accrole').html(data);
                }
            });
        ...
        function print_report(){
            ...
            // $.ajax({
            //     type: "POST",
            //     url: "user-account-print-report.php",
            //     data: "data",
