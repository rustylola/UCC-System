...
$query = "SELECT vax_user_acc.*,vax_user_role.account_user_role,vax_user_role.account_main_role FROM `vax_user_acc` JOIN vax_user_role ON vax_user_acc.account_role=vax_user_role.id WHERE vax_user_role.account_main_role='user'";
