...
if(isset($_POST['selecteddeleteid'])){
    ...
    $querydelete = "DELETE FROM vax_created WHERE vax_created.account_unique_id='".$selecteddeleteid."'";
    ...
    $query = "SELECT * FROM vax_created WHERE account_unique_id='".$getuniqueID."'";
    ...
    $query = "SELECT * FROM vax_created WHERE account_unique_id='".$getdeleteID."'";
    $result = mysqli_query($mysqli,$query);
    $count = mysqli_num_rows($result);
    $output= '';
    if($count>0){
